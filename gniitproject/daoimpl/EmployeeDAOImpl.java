...
public class EmployeeDAOImpl implements EmployeeDAO {
    ...
    public int addEmployee(Employee employee) {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("insert into employees(employeeid,employeename,email) values(?,?,?)");
        ...
        try {
            ...
            if(resultSet!=null){
                ...
                while(resultSet.next()){
                    ...
                    Employee employee = new Employee(employeeId,employeeName,email);
